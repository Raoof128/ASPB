...
from .scanner import SecretScanner, SecretRisk
...
def parse_args() -> argparse.Namespace:
    ...
    scan_parser.add_argument("--format", choices=["json", "csv", "markdown", "table"], default="table", help="Output format")
    scan_parser.add_argument("--output", help="Output file path (e.g., report.csv)")
    scan_parser.add_argument("--critical-only", action="store_true", help="Only show expired or critical secrets (<= 30 days)")
